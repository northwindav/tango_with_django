...
SECRET_KEY = '9v89ty@(x-vl_fl_pn16x%dz$r+k@_t7y+&xtgmz5+6d4(b5u('
...
# This is not required if we use the default PBKDF2 algorightm,
...
# url to redirect for users who aren't logged in and try to access restricted areas
